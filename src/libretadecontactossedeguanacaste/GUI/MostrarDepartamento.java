 ...
 * @author KURISUTIAN
 */
public class MostrarDepartamento extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarDepartamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
