 ...
 * @author KURISUTIAN
 */
public class MostrarInstancias extends javax.swing.JFrame {

    private DefaultListModel DatosDeLaTabla;
private GestorDeInstancias GestorDeInstancias;
    /**
     * Creates new form MostraInstancias
     */
    public MostrarInstancias() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecione la Instancia:");
    ...
    private void LlenarListaDeInstancias()
    {
         ...
         DatosDeLaTabla =new DefaultListModel();
         GestorDeInstancias= new GestorDeInstancias();
         Instancias listaInstancias[]= new Instancias[1];
      
         
         for (int i = 0; i < GestorDeInstancias.ObtenerLasInstancias().size(); i++) {
             
            listaInstancias[0]= GestorDeInstancias.ObtenerLasInstancias().get(i);
              DatosDeLaTabla.add(i,listaInstancias);
        }
         
         JListaDeInstancias.setModel(DatosDeLaTabla); 
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarInstancias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarInstancias().setVisible(true);
            }
        });
    }
